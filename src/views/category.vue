...
<template>
  <div>
    <navbar>
      <p slot="center">搜索导航</p>
    </navbar>
    <div class="content">
      <p>this is the category page</p>
      <button @click="sendrequest">点击发送网络请求</button>
      <p>{{content}}</p>

      <better-scroll class="mybsroll" @scrolling="myscroll" :probeType='3'>
        <ul>
          <li>1 <img src="@/assets/logo.png" alt=""></li>
          <li>2</li>
          <li>3</li>
          <li>4</li>
          <li>5</li>
